...
/// \brief Convert a column type name to duckdb type.
/// \param type_name the type name.
/// \return          The equivalent duckdb type.
...
class DuckDBFlightSqlServer : public FlightSqlServerBase {
 public:
  ...
  static arrow::Result<std::shared_ptr<DuckDBFlightSqlServer>> Create(const char* path,
